...
** Configurations
Configurations of emacs behaviour.
...
** Package Management
*** Instalation
Custom function to install use-package, from which other packages can be installed:
#+begin_src emacs-lisp
...
*** Use-package
Configurations for use-package:
#+begin_src emacs-lisp
(eval-when-compile
...
** Dashboard
Configurations for the splash screen.
...
** Windows and Frames
Configurations for windows and frames.
...
** Focus / Distractions
Configurations for capabilities to enhance focus and avoid distractions.
...
** Help
Configurations for help capabilities.
...
** Text Highlight
Configurations for text highlighting capabilities.
...
** Indentation
Configurations for indenting capabilities.
...
** Auto Completion
Configurations for auto completion capabilities.
...
** Text Folding
Configurations for text folding capabilities.

Configurations for the origamy package, which allows code blocks to be folded:
#+begin_src emacs-lisp
(use-package origami
  :requires (dash s)
  :config
...
** Haskell
Configurations for the haskell language.
...
** Latex
Configurations for LaTeX editing.
