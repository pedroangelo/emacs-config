...
Configuration for the [[https://github.com/tmalsburg/guess-language.el][~guess-language~]] package, which automatically detects the language being typed and switches spell checker.
#+begin_src emacs-lisp
