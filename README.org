...
** Brainfuck
Configurations for the ~brainfuck-mode~ package, which provides Brainfuck keyword highlighting ([[https://github.com/tom-tan/brainfuck-mode][Github]]):
#+begin_src emacs-lisp
...
#+begin_src emacs-lisp
  ...
  ;;                           (floor (* (window-pixel-width) 0.7)))
  ;;               (org-display-inline-images t t))))

  ;; Display inline images in orgmode
  (setq org-startup-with-inline-images t)
  ;; Set size of displayed inline orgmode images to full size, unless there a width hint (format #+ATTR_ORG: :width <width>)
